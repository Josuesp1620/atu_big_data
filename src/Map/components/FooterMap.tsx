...
export default function FooterMapComponent() {
  ...
  const handleCheckboxChange = (index, checked) => {
    ...
    if (checked) {
      ...
      const indexToRemove = filters.indexOf(index);
